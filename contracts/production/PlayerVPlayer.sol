...
contract WithPlayerProduction{
    ...
    function endSession() internal {
        sessionEndTime = 60 + sessionStartTime;
    }
    ...
    function pay(address _winner) internal {
        uint256 winnerAmount = 35 * 10 ** 17; // 3.5 link
        link.transfer(_winner, winnerAmount);
    }


    function rewardWinner(uint256 _p1Item, uint256 _p2Item, address _p1Address, address _p2Address) internal {
